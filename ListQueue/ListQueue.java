...
public class ListQueue <E> {
	...
	public E remove() {
		...
		front = front.getNext(); //front가 front 다음 노드를 가리키게한다.
		if(isEmpty()) rear = null; //  q가 empty이면 rear = null
		size--; //q 항목 수 1감소
		return frontItem;
	}
	public void print() { //q의 항목들을 front부터 차례로 출력
		if(isEmpty()) System.out.print("Q가 empty임");
		else
